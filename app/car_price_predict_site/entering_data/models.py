...
class Car(models.Model):
    ...
    ENGINE_VOLUME = models.CharField(max_length=30, choices=EngineVolume.choices)
    MILEAGE = models.IntegerField()
    CYLINDERS = models.IntegerField()
    GEAR_BOX_TYPE = models.CharField(max_length=30, choices=GearBoxType.choices)
    DRIVE_WHEELS = models.CharField(max_length=30, choices=DriveWheels.choices)
    DOORS = models.CharField(max_length=30, choices=Doors.choices)
    WHEEL = models.CharField(max_length=30, choices=Wheel.choices)
